...
<body>
	...
	<div id="img_more_div" align="right">
		<button class="btn btn-outline-primary" data-toggle="modal"
			data-target="#imgModal" id="img_more_btn">사진+</button>
	</div>
							...
							<div id="tab-1" class="tab-content current">
								<div id="tab-1_btn">
									...
									<button type="button" class="btn btn-outline-danger"
										data-toggle="modal" data-target="#reportModal" id="reportbtn">
										신고</button>
									<button type="button" class="btn btn-outline-info"
										data-toggle="modal" data-target="#myModal" id="modifybtn">
										편집</button>
								</div>
								<table width="100%">
									<tr>
										<td><img src="img/restaurant/전화번호.png"
											data-toggle="tooltip" title="전화번호"> <span
											id="r_info_phone">${info.restaurant.r_phone}</span></td>
									</tr>
									<tr>
										<td><img src="img/restaurant/위치.png"
											data-toggle="tooltip" title="위치"> <span
											id="r_info_address">${info.restaurant.r_address}</span></td>
									</tr>
									<tr>
										<td><img src="img/restaurant/영업시간.png"
											data-toggle="tooltip" title="영업시간"> <span
											id="r_info_rundate">${info.restaurant.r_rundate}</span> <span
											id="r_info_runtime">${info.restaurant.r_runtime}</span></td>
									</tr>
									<tr>
										<td><img src="img/restaurant/메뉴.png"
											data-toggle="tooltip" title="메뉴"> <span
											id="r_info_menu">${info.restaurant.r_menu}</span></td>
									</tr>
									<tr>
										<td><img src="img/restaurant/소개.png"
											data-toggle="tooltip" title="소개"> <span
											id="r_info_intro">${info.restaurant.r_intro}</span></td>
									</tr>
									<tr>
										<td><img src="img/restaurant/편의시설.png"
											data-toggle="tooltip" title="편의시설"> <span
											id="r_info_enjoy">${info.restaurant.r_enjoy}</span></td>
									</tr>
								</table>
							</div>
				...
				<form name="modify_info">
					...
					<div class="modal-body">
						<table width="100%" class="info">
							<tr>
								<td height="20px"><img src="img/restaurant/전화번호.png"
									data-toggle="tooltip" title="전화번호"></td>
								<td width="100%"><input type="text" class="form-control"
									name="rm_phone" id="modify_phone"></td>
							</tr>
							<tr>
								<td height="20px"><img src="img/restaurant/영업시간.png"
									data-toggle="tooltip" title="영업시간"></td>
								<td width="100%"><input type="text" class="form-control"
									name="rm_rundate" id="modify_rundate"> <input
									type="text" class="form-control" name="rm_runtime"
									id="modify_runtime"></td>
							</tr>
							<tr>
								<td height="20px"><img src="img/restaurant/메뉴.png"
									data-toggle="tooltip" title="메뉴"></td>
								<td width="100%"><input type="text" class="form-control"
									name="rm_menu" id="modify_menu"></td>
							</tr>
							<tr>
								<td height="20px"><img src="img/restaurant/소개.png"
									data-toggle="tooltip" title="소개"></td>
								<td width="100%"><input type="text" class="form-control"
									name="rm_intro" id="modify_intro"></td>
							</tr>
							<tr>
								<td height="20px"><img src="img/restaurant/편의시설.png"
									data-toggle="tooltip" title="편의시설"></td>
								<td width="100%"><input type="text" class="form-control"
									name="rm_enjoy" id="modify_enjoy"></td>
							</tr>
						</table>
					</div>
				</form>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form name="report_info">
					<input type="hidden" name="r_num" value="${info.restaurant.r_num}">
					<input type="hidden" name="m_mail1" id="report_email"> <input
						type="hidden" name="m_mail2" value="${email.email_num}">
	...
	<div class="modal fade" id="UserModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<form name="user_info">
					<input type="hidden" name="req_mail" value="${email.email_num}">
					<input type="hidden" name="resp_mail" id="u_mail">

					<div class="modal-body">
						<table width="100%" class="info">
							<tr>
								<td rowspan="3"><img src="img/No_Image.jpg" width="150px"
									id="u_img"></td>
								<td><label id="u_nick">Mr.Smith</label></td>
								<td rowspan="2" width="100%" align="right"
									style="vertical-align: top;">
									<button type="button" class="btn btn-success"
										data-dismiss="modal" id="u_btn">친구신청</button>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2"><img src="img/eva/하트on.png" id="u_like_img"
									width="20px"><label id="u_like">95</label> <img
									src="img/eva/마크on.png" id="u_mark_img" width="20px"><label
									id="u_mark">35</label> <img src="img/eva/리뷰.png"
									id="u_review_img" width="20px"><label id="u_review">105</label>
								</td>
							</tr>
							<tr>
								<td colspan="3"><textarea rows="6" cols="60"></textarea></td>
							</tr>
						</table>
					</div>
				</form>
