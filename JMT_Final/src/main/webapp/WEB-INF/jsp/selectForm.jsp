...
#selectMain {
	background-image:
		url(https://www.publicdomainpictures.net/pictures/270000/velka/tomatoes-basil-food-tomato-1536133120iSk.jpg);
	opacity: 0.9;
}
</style>
										...
										if (data[i].r_photo != null)
											...
											$.ajax({
												...
												success : function(image) {
													result += '<img class="card-img-top saveImg" id = "'+data[i].r_num+'" src="'+image+'" alt="Card image cap" style="height: 200px;">';
							...
							for (var i = 1; i <= 5; i++) {
								...
								for (var j = 0; j < 6; j++) {
									...
									if (list[i] != 0 && list[i] != null) {
										if (list[i] == j) {
											result += '<option value="'+j+'" selected>' + rank_list[j] + '</option>';
										} else if (j == 0) {
											result += '<option value="'+j+'">' + rank_list[j] + '</option>';
										}
									} else {
										if (rank[j] != '') {
											result += '<option value="'+j+'">' + rank_list[j] + '</option>';
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="width: 600px;">
          ...
          <div class="modal-body" style="width: 100%; text-align: center;">
            ...
            <div id="demo" class="carousel slide" data-interval="false" style="text-align: center;">
            ...
            <form id="p_form">
              <table align="center">
                ...
                <tr>
                  <td>
                    <select name="rank1" class="rank-item form-control" size="6"></select>
                  </td>
                  <td>
                    <select name="rank2" class="rank-item form-control" size="6"></select>
                  </td>
                  <td>
                    <select name="rank3" class="rank-item form-control" size="6"></select>
                  </td>
                  <td>
                    <select name="rank4" class="rank-item form-control" size="6"></select>
                  </td>
                  <td>
                    <select name="rank5" class="rank-item form-control" size="6"></select>
                  </td>
                </tr>
                <tr>
                  <td colspan="5" align="right">
                    <button type="button" class="btn btn-outline-info" id="clear_btn">초기화</button>
                  </td>
                </tr>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-success" data-dismiss="modal" id="save_btn">저장</button>
          </div>
        </div>
      </div>
    </div>
