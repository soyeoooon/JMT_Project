...
public class adminReport {
	...
	public String toString() {
		return "adminReport [rep_num=" + rep_num + ", r_name=" + r_name + ", rm_num=" + rm_num + ", r_num=" + r_num
				+ ", req=" + req + ", resp=" + resp + ", replist_content=" + replist_content + ", represult_content="
				+ represult_content + ", rep_date1=" + rep_date1 + ", rep_date2=" + rep_date2 + "]";
	}
